...
import {selectShopAnyOne} from "../../api/request"
  ...
  return (
    <div className={style.results}>
      ...
      <div key={item.detailId} className={style.results_top}>
        ...
        <li><span>所属分类:</span><Tag color="#f50">{item.parent}</Tag></li>
        <li><span>商品原价:</span> <Tag color="cyan">{item.prePrice}元</Tag></li>
