...
export default function SuccessTip (){
  ...
  return (
    <>
      <Modal style={{userSelect:"none"}} closable={false} keyboard={false} maskClosable={false} footer={null} visible={successDialogTip} onOk={handleOk} onCancel={handleCancel}>
      <Result status="success" title={TipText}/>
      {isShowCar?(<div className={style.btns}><Button key="buy" onClick={back}>返回</Button>
