...
import { message, Result, Button, Tooltip,Spin,Empty } from "antd"
      ...
      )}
      {
        !loading &&(
          ...
          {collectList.length ? collectList?.map(item => (
            ...
            <Empty description="您暂未收藏任何商品。" />
            <Button className={style.btn} type="primary" onClick={tiaoGoods}>逛一逛吧</Button>
            </div>
            ):''
          }
        </div>
